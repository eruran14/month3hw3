...
import com.eru.month3hw3.databinding.FragmentSecondPageBinding
...
class SecondPageFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        binding = FragmentSecondPageBinding.inflate(LayoutInflater.from(requireContext()), container, false)
        return binding.root
    }
